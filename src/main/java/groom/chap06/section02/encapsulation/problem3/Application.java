package groom.chap06.section02.encapsulation.problem3;

public class Application {

    public static void main(String[] args){

        /* 목표. 필드에 직접 접근 시 발생하는 문제를 해결하는 방법을 이해하고 적용할 수 있다. */
        /* 몬스터 객체를 여러 개 생성해보자 */
        ...
        monster3.setInfo("피카츄");
        monster3.setHp(300);

        Monster monster4 = new Monster();
        monster4.setInfo("파이리");
        monster4.setHp(500);
