package groom.chap06.section02.encapsulation.problem1;

public class Application {

    public static void main(String[] args) {

        /* 목표. 필드에 직접 접근하는 경우 발생할 수 있는 문제점을 이해할 수 있다. (1) */
        ...
        /* 이처럼 겅증되지 않은 값을 넣을 때 문제가 발생할 수 있다.
        ...
        /* 음수로 입력을 제한하는지 확인하도록 4번 몬스터 한 마리 더 생성 */
        Monster monster4 = new Monster();
        monster4.name = "프라켄슈타인";
        monster4.setHp(-1000);
