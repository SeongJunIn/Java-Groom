package groom.chap06.section02.encapsulation.problem4;

public class Application {

    public  static void main(String [] agrs){

        /* 목표. 접근제한자에 대해 이해하고 직접 필드에 접근하지 못하게 강제화 할 수 있다. */
        /* Monster 클래스의 필드를 private 만둘고 객체를 생성한 뒤 필드에 직접 접근하면 compile error를 발생시킨다.
         *  접근을 허용하지 않았기 때문에 직접 접근할 수 없다는 의미이다.
         *  메소드를 통한 간접 접근을 강제화 한 것이다.
         */

        /* 1. private 필드에 직접 접근 하여 comile error 발생 확인 */
        Monster monster1 = new Monster();
//        monster1.kinds = "삐삐";                  //에러 발생
//        monster1.hp = "100";                     //에러 발생
